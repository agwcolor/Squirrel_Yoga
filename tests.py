...
class BaseTestCase(unittest.TestCase):
        ...
        with self.app.test_client() as c:
            ...
            teacher = (
                Teacher.query.filter(
                    Teacher.name == "Test_Teacher").one_or_none())
            print("Teacher is", teacher.name, res.__dict__, "status")
            print("res.status_code is", res.__dict__)
    ...
    def test_modify_teacher(self):
        ...
        with self.app.test_client() as c:
            ...
            teacher = (
                Teacher.query.filter(
                    Teacher.temperament == "test_temperament2") .one_or_none())
            print(
                teacher.temperament,
                " is test_temperament",
                teacher.name,
